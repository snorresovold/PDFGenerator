...
function App() {
  return (
    <div>
      ...
      />
      <OppdragsInformasjon ordrenummer={"Ordre123"} tksMontor={"TksMontor"} />
      <UtførtTable tasks={checklistpoints} />
      <OppfolgingsTable followUps={oppfølgingTableData} />
      <FakturaKommentar kommentar={"Dette er en fakturakommentar"} />
      <TKSSignatur
      ...
      />
      <SigneringsNotat kommentar={"Dette er et signeringsnotat"} />
    </div>
  );
}
export default App;